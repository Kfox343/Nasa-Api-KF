...
const PhotoContainer = () => {
  ...
  const apiStr = "https://api.nasa.gov/planetary/apod?api_key=abwfjrqEWEii8oCg4NGRs5DpWQaR3JflqIwmEK75";

  // Example of api URL:
  // "https://api.nasa.gov/planetary/apod?api_key=API_KEY_HERE";
  // "https://api.nasa.gov/planetary/apod?api_key=abwfjrqEWEii8oCg4NGRs5DpWQaR3JflIwmEK75";
